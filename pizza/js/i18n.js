...
window.PizzaI18N = (function(){
  const DICT = {
    es: {
      ...
      hydGreenHead: "Napolitana clásica · hidratación baja-media",
      ...
      yeastAutoHint: "Se ajusta según la temperatura ambiente.",
      yeastManualHint: "Valor fijo: no cambia con la temperatura.",
      ...
      recipeHeader: "🍕 RECETA MASA NAPOLITANA (calculatupizza.com)",
      recipePizzas: "Pizzas",
      recipeOf: "de",
    ...
    en: {
      ...
      hydGreenHead: "Classic Neapolitan · low-medium hydration",
      ...
      yeastAutoHint: "Adjusts with the room temperature.",
      yeastManualHint: "Fixed value: won't change with temperature.",
      ...
      recipeHeader: "🍕 NEAPOLITAN DOUGH RECIPE (calculatupizza.com)",
      recipePizzas: "Pizzas",
      recipeOf: "of",
