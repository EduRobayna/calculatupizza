...
window.PizzaI18N = (function(){
  const DICT = {
    es: {
      ...
      yeastScaleNote: "Para pesar tan poca levadura usa una báscula de precisión (0,1 g); si no tienes, disuélvela bien en el agua de la masa.",
    ...
    en: {
      ...
      yeastScaleNote: "To weigh such a small amount of yeast use a precision scale (0.1 g); if you don't have one, dissolve it well in the dough water.",
